...
<div>
    ...
    <div>
        <sui-modal class="modal2" v-model="open">
            ...
            <sui-modal-actions>
                <sui-button v-if="modelTitle === '修改Room'" positive @click.native="toggle">
                    提交
                </sui-button>
            </sui-modal-actions>
        </sui-modal>
...
export default {
    ...
    methods: {
        ...
        exportToExcel() {
            let headers = ['id', 'roomid', 'certid', 'owner', 'address', 'roomname', 'usage', 'space', 'optional', 'age', 'build_date', 'origin_value', 'room_value', 'dep', 'net_value', 'dep_rate', 'internal_info', 'cur_status'];
