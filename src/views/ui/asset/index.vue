  ...
  <wl-container>
    <div>
          ...
          >
            <template slot="table-row" slot-scope="props">
              <span v-if="props.column.field == 'action'">
                <span>
                  <el-button
                    @click.native.prevent="recommendList(props.row)"
                    type="text"
                    size="small"
                  >
                    推荐
                  ...
                  <el-button
                    @click.native.prevent="openTagDialog(props.row)"
                    type="text"
                    size="small"
                  >
                    标签
                  ...
                  <el-button
                    @click.native.prevent="changePolicy(props.row)"
                    type="text"
                    size="small"
                  >
                    修改
                  ...
                  <el-button
                    @click.native.prevent="deletePolicy(props.row)"
                    type="text"
                    size="small"
                  >
                    删除
      ...
      <el-dialog title="公司列表" :visible.sync="dialogTableVisible">
        <el-row v-show="!showReview">
          <el-col :span="12">
            ...
            <div class="grid-content bg-purple">
              <el-table
                max-height="500px"
                :data="recommendDataList.data"
                ref="multipleTableRecommend"
                style="width: 100%"
              ...
              >
                ...
                <el-table-column
                  ...
                  width="200"
                ></el-table-column>
                <el-table-column property="SORT" label="推荐指数" width="200"
            ...
            <div class="grid-content bg-purple-light">
              ...
              <div class="grid-content bg-purple">
                <el-table
                  max-height="500px"
                  @filter-change="filterChange"
                  :data="offenUsedCompanys"
                  ref="multipleTable"
                  style="width: 100%"
                  @selection-change="handleSelectionChangeH"
                >
                  <el-table-column type="selection" width="55">
                  </el-table-column>
                  <el-table-column
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button
            ...
            @click="notifyCompany"
            v-show="showReview"
            :disabled="recommendReviewList.length == 0"
            >推送</el-button
          >
          <el-button type="primary" @click="prevNotify" v-show="showReview"
            >上一步</el-button
          >
        </span>
      </el-dialog>
      ...
      >
        ...
        <el-button style="margin-top: 12px; margin-bottom: 12px" @click="next"
          >下一步</el-button
        >
        <div class="tag-group">
          <span class="tag-group__title" style="font-size: 25px;"
            >已打标签</span
          >
          <div style>
            <el-tag
              class="tableTag"
              v-for="(item, index) in showItems1"
              :key="item.TAG_ID"
              :type="tagType"
              effect="dark"
              closable
    ...
    recommendList(data) {
      ...
      getCompanysApi().then((result1) => {
        ...
        getRecommendCompanysApi(data).then((result) => {
          ...
          this.recommendDataList.data.map(
            (one) =>
              (one.SORT = (parseFloat(one.SORT).toFixed(2) * 10).toFixed(2))
          );
