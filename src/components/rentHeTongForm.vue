    ...
    <sui-form>
      <sui-form-fields inline>
        ...
        <sui-form-field>
          ...
          <sui-input
            placeholder="出租方地址"
            v-model="singleEntry.rentaddress"
          />
        </sui-form-field>
        <sui-form-field>
          <label>出租方联系人:</label>
          <sui-input
            placeholder="出租方联系人"
            v-model="singleEntry.rentcontact"
          />
        </sui-form-field>
      </sui-form-fields>
      <sui-form-fields inline>
        <sui-form-field>
          ...
          <sui-input
            placeholder="出租方联系人电话"
            v-model="singleEntry.rentmobile"
          />
        </sui-form-field>
        <sui-form-field>
          <label>出租方联系人职务:</label>
          <sui-input
            placeholder="出租方联系人职务"
            v-model="singleEntry.title"
          />
        </sui-form-field>
        <!-- <sui-form-field>
                <label>出租方</label>
      ...
      <div :key="componentKey" v-for="(item, index) in singleEntry.spaces">
        <sui-form-fields inline>
          <sui-form-field>
            ...
            <sui-input
              placeholder="面积"
              v-model="singleEntry.spaces[index].space"
              type="number"
              required
            />
          </sui-form-field>
          <sui-form-field>
            ...
            <sui-input
              placeholder="单价"
              v-model="singleEntry.spaces[index].price"
              type="number"
            />
          </sui-form-field>
          <sui-form-field>
            ...
            <sui-input
              placeholder="描述"
              v-model="singleEntry.spaces[index].pricename"
              type="text"
            />
          </sui-form-field>
          <sui-button
            circular
            icon="add"
            @click.prevent="addOneMore"
            v-show="index == singleEntry.spaces.length - 1"
          />
          <sui-button
            circular
            icon="minus"
            @click.prevent="deleteOne(index)"
            v-show="singleEntry.spaces.length > 1"
          />
        </sui-form-fields>
      </div>
      <sui-form-fields inline>
