...
<div>
    <sui-form>
        <sui-form-fields inline>
            <label for="singleRoom.type">请选择房屋类型:</label>
        </sui-form-fields>
        <sui-form-fields> 
            <sui-form-field>
            ...
            <sui-form-field>
                <sui-checkbox radio name="type" label="租赁房屋" value="2" v-model="singleRoom.type"/>
            </sui-form-field>
        </sui-form-fields>
        ...
        <sui-form-fields>    
            <sui-form-field>
                <label>选择房屋</label>
                <sui-dropdown placeholder="选择房屋" selection :options="singleRoom.roomoptions" v-model="singleRoom.room" />
            </sui-form-field>
        </sui-form-fields>
        <sui-form-fields>
        <sui-form-field>
